...
IFX_INLINE void         wait(unsigned int timeout);
IFX_EXTERN void         waitPoll(void);
IFX_EXTERN void         waitTime(unsigned int timeout);
...
IFX_INLINE void wait(unsigned int timeout)
{
    Ifx_TickTime deadLine = getDeadLine(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, timeout));
